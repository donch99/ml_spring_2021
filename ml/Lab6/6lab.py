...
ax = plt.scatter(X_test['density_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['density_scaled'], Y_predict, marker='.', label='Предсказанные данные')
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['density_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['density_scaled'], Y_predict3, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('density_scaled')
plt.ylabel('price')
plt.plot(n_estimators_1)
...
ax = plt.scatter(X_test['density_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['density_scaled'], Y_grad_pred, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('density_scaled')
plt.ylabel('price')
...
grad1 = GradientBoostingRegressor(n_estimators=50, max_features=1, min_samples_leaf=0.01, random_state=10)
...
fig1 = plt.figure(figsize=(7, 5))
ax = plt.scatter(X_test['density_scaled'], Y_test, marker='o', label='Тестовая выборка')
plt.scatter(X_test['density_scaled'], Y_grad_pred1, marker='.', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('density_scaled')
plt.ylabel('price')
plt.plot(n_estimators_1)
...
plt.scatter(X_test['density_scaled'], Y_test, marker='s', label='Тестовая выборка')
plt.scatter(X_test['density_scaled'], lr_y_pred, marker='o', label='Предсказанные данные')
plt.legend(loc='lower right')
plt.xlabel('density_scaled')
plt.ylabel('price')
plt.show()
